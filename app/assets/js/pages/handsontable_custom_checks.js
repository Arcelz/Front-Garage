    ...
    var hot_html_cells_data = [
        {
            ...
            description: "Limitless is one of the best application templates ever built. Very flexible and clean admin template based on Bootstrap and Less. Available in 4 different layout.",
        ...
        },
        {
            ...
            description: "It's Brain admin template is based on Bootstrap framework and includes a lot of different features. Comes with fixed and liquid layout in both light and dark versions.",
