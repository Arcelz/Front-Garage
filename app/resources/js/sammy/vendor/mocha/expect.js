...
(function (global, module) {
   ...
   * Inspects an object.
   *
   * @see taken from node.js `util` services (copyright Joyent, MIT license)
   * @api private
   */
  ...
  function i (obj, showHidden, depth) {
    ...
    function format (value, recurseTimes) {
      ...
      if (value && typeof value.inspect === 'function' &&
          // Filter out the util services, it's inspect function is special
          value !== exports &&
   ...
   *
   * @see taken from node.js `assert` services (copyright Joyent, MIT license)
   * @api private
   */
